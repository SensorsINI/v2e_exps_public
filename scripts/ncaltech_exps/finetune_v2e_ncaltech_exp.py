...
Finetune the model using N-Caltech data (real events).
...
class FinetuneV2ENCaltechExp(pl.LightningModule):
    def __init__(self, cfg):
        super(FinetuneV2ENCaltechExp, self).__init__()
    ...
    def configure_optimizers(self):
        ...
        scheduler = optim.lr_scheduler.StepLR(
            optimizer, step_size=100, gamma=0.1, verbose=True)
        return {
            'optimizer': optimizer,
